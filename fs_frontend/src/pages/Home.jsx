    ...
    <Box sx={{ position: "relative", minHeight: "100vh" }}>
      ...
      {theme.backgroundVideo && (
        <BackgroundVideo
          ...
          sx={{ filter: isDark ? "brightness(0.5) saturate(1.4)" : "brightness(0.8)", pointerEvents: "none", zIndex: -2 }}
        />
      )}
      ...
      <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ py: 4 }}>
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            <Avatar src="/logo.png" variant="rounded" sx={{ width: 45, height: 45, bgcolor: "transparent" }} />
            ...
            {!isLoading && (isAuth ? (
              <Button
                ...
                sx={{
                  ...
                  fontWeight: 700, borderRadius: "12px", px: 3, py: 1,
                  boxShadow: `0 4px 16px ${accent}40`,
                  transition: "all 0.2s",
                  "&:hover": { bgcolor: theme.accentHover || accent, transform: "translateY(-2px)" },
                }}
              >
                Ir a mi cuenta
              </Button>
              ...
              <Button
                ...
                sx={{
                  color: theme.primaryText, fontWeight: 700,
          ...
          <Grid item xs={12} lg={8}>
            <Box>
              ...
              <Typography variant="h5" sx={{
                color: theme.secondaryText, mb: 6, fontWeight: 400,
              ...
              <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                {isAuth ? (
                  <Button
                    ...
                    variant="contained"
                    sx={{
                      bgcolor: accent, color: isDark ? "#1a1200" : "#fff",
                      px: 6, py: 2.5, borderRadius: "50px",
                      fontSize: "1.1rem", fontWeight: 800,
                      boxShadow: `0 8px 32px ${accent}40`,
                      "&:hover": { bgcolor: theme.accentHover || accent, transform: "translateY(-4px)", boxShadow: `0 12px 40px ${accent}60` },
      ...
      <Box sx={{ bgcolor: theme.primaryBack, pt: 10, pb: 15, position: "relative", zIndex: 2 }}>
        <Container maxWidth="lg">
          <Grid container spacing={3}>
            {[
              ...
              <Grid item xs={12} md={4} key={index}>
                <Card sx={{
                  p: 4, height: "100%", bgcolor: theme.secondaryBack,
                  borderRadius: "40px", border: `1px solid ${theme.borderLight || accent + "10"}`,
                  transition: "0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
                  display: "flex", flexDirection: "column",
                  "&:hover": { bgcolor: theme.tertiaryBack, borderColor: accent, transform: "translateY(-10px)", boxShadow: `0 20px 40px rgba(0,0,0,0.1)` },
                }}>
                  <Box sx={{ width: 60, height: 60, borderRadius: "20px", bgcolor: `${accent}15`, color: accent, display: "grid", placeItems: "center", mb: 3 }}>
                    {item.icon}
                  </Box>
                  <Typography variant="h6" sx={{ color: theme.primaryText, fontWeight: 900, mb: 1.5 }}>{item.title}</Typography>
                  <Typography sx={{ color: theme.secondaryText, lineHeight: 1.6 }}>{item.desc}</Typography>
                </Card>
              </Grid>
            ))}
          </Grid>
          ...
          <Box sx={{
            mt: 15, p: { xs: 4, md: 8 }, borderRadius: "60px",
            bgcolor: theme.tertiaryBack, textAlign: "center",
            ...
            <Button
              ...
              onClick={isAuth ? () => navigate("/app/searchnewfriends") : undefined}
              sx={{
                bgcolor: theme.primaryText, color: theme.primaryBack,
                px: 8, py: 2.5, borderRadius: "50px", fontWeight: 900, fontSize: "1rem",
                "&:hover": { bgcolor: accent, color: isDark ? "#1a1200" : "#fff", transform: "scale(1.05)" },
                transition: "all 0.3s",
              }}
            >
