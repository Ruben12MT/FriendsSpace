...
export default function UserPage() {
  ...
  const refreshButtonState = useCallback(async () => {
    ...
    try {
      ...
      // Usuario normal viendo perfil de admin/dev — solo buscar reporte abierto
  ...
  const getModalContent = () => {
    const cfg = {
      ...
      BLOCK_AND_REPORT: {
        ...
        msg: (
          <Box sx={{ pt: 1 }}>
            <Typography mb={2}>Indica el motivo del reporte:</Typography>
            <TextField
              fullWidth
              multiline
              rows={3}
        ...
        <Box sx={{ px: 3, pb: 3 }}>
          ...
          >
            ...
            <Box display="flex" gap={1}>
              {!isOwnProfile ? (
                <>
                  {/* Usuario normal viendo perfil de admin/dev */}
